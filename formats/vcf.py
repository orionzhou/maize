...
if __name__ == '__main__':
    ...
    sp1 = sp.add_parser("vcf2fas", help = "make an alternate fasta using vcf")
    ...
    sp1 = sp.add_parser("vcf2bed", help = "extract variant locations")
    sp1.add_argument('fi', help = 'input vcf file')
    sp1.add_argument('--noindel', action = 'store_true', help = 'remove InDel')
    sp1.set_defaults(func = vcf2bed)
   
    sp1 = sp.add_parser("vcf2tsv", help = "vcf -> tsv")
    sp1.add_argument('fi', help = 'input vcf file')
